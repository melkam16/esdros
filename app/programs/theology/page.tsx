...
export const metadata: Metadata = {
  ...
  description: 'Explore the BA (Transition), Diploma, and Certificate Theology programs offered at Esderos EOTC Theological Seminary.',
};
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2 space-y-12">
          ...
          <div className="space-y-8">
            ...
            {/* Diploma */}
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <h3 className="text-xl font-bold text-[#1e508d] mb-2">Diploma in Theology</h3>
