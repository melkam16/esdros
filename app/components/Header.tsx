...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#009fe5] shadow-md transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <img
            ...
            className="h-12 w-12 object-contain drop-shadow transition-transform duration-300 group-hover:scale-105"
          />
          <div className="leading-tight">
            <p className="text-white font-bold text-sm leading-none tracking-tight">Esdros Theological Seminary</p>
            <p className="text-blue-100 text-xs leading-none mt-0.5 font-medium">Mahibere Kidusan North America</p>
          </div>
        </Link>
        ...
        <button
          ...
          className="md:hidden p-2 text-white hover:bg-white/10 rounded-lg transition duration-300"
      ...
      <div
        className={`md:hidden fixed inset-x-0 top-16 bg-[#009fe5] border-t border-white/10 shadow-2xl z-40 transition-all duration-300 ease-in-out origin-top ${
