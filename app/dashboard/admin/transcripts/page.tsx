  ...
  return (
    <div className="pl-0 lg:pl-64 pt-14 lg:pt-0 min-h-screen bg-slate-50">
      ...
      <main className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Official Transcripts</h1>
          <p className="text-sm text-slate-500 mt-1">Generate, audit, and distribute official student academic records.</p>
        </div>
        <TranscriptClient students={students} />
      </main>
    </div>
  );
}
